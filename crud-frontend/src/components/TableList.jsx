export default function TableList({ handleOpen}) {
    ...
    const clients = [ 
        ...
        {id: 2 ,name: "John Doe1", email: "John.Doe1@gmail.com", job:"Developer1", rate: "101", isactive: true}, 
        {id: 3 ,name: "John Doe2", email: "John.Doe2@gmail.com", job:"Developer2", rate: "102", isactive: false} 
    ]
